...
function renderTable(payload) {
  try {
    ...
    // Render Table Footer Rows (Row 1: OVERALL TOTALS across N columns, Row 2: ITM / OTM BREAKDOWN across N columns)
    if (tableFoot) {
      ...
      tableFoot.innerHTML = `
        <!-- Row 1: TOTAL SUMMARY (Full N-Column Populated) -->
        <tr class="total-row">
        ...
        <!-- Row 2: ITM & OTM BREAKDOWN (Full N-Column Populated) -->
